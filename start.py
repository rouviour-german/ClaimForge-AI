...
def check_env_file():
    ...
    env_path = Path("claimforge/.env")
    if not env_path.exists():
        print_warning(".env file not found. Copy from .env.example")
        example_path = Path("claimforge/.env.example")
...
def start_application():
    ...
    try:
        import uvicorn
        from claimforge.core.settings import settings
...
def main():
    ...
    if start == 'y':
        ...
        print("  python -m uvicorn claimforge.api.app:app --reload")
